...
const Hero = () => {
  ...
  return (
    <div className="relative h-screen">
      ...
      {/* Content Hero */}
      <div className="relative z-10 bg-black  bg-opacity-50 lg:bg-inherit  flex items-center justify-center h-screen text-white sepia-0">
        ...
        <div className="lg:flex lg:bg-black lg:bg-opacity-50 absolute  left-0 w-1/2 h-height lg:h-full items-center justify-center">
          <div className="w-[460px]">
            <img
              src={logoSolaris}
              alt="Solaris"
              className="my-10 pl-8 pt-8 lg:w-[296px] lg:h-[190px] sepia-0"
            />
