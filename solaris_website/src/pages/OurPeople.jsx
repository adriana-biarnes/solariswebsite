            ...
            <div 
                className={`relative preserve-3d ${!isFaceVisible ? 'rotate-y-180' : ''} w-full h-full duration-1000`}>
                    <div className="absolute w-full h-full backface-hidden">
                        <img src={face} alt="" className="w-full h-full  min-h-[450px]" />
                    </div>
                    <div className="absolute rotate-y-180 w-full h-full backface-hidden  bg-gray-100 rounded-xl">
                        <img src={back} alt="" className="w-full h-full min-h-[380px] rounded-xl" />
                    </div>
            </div>
        </div>          
    )}
...
const OurPeople = () =>{
    return(
        <div className="flex flex-col min-h-screen">
            <BlueNavBar />
            <div className="flex flex-col px-16 py-8 gap-6 lg:mx-52 flex-grow">
