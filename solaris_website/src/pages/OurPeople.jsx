      ...
      >
        <div className="absolute w-full h-full backface-hidden">
          <img
            src={face}
            alt=""
            className="w-full h-full rounded-3xl min-h-[460px] md:w-72 md:min-h-[420px] lg:min-h-[460px] lg:min-w-80"
          />
        </div>
        <div className="absolute rotate-y-180 w-full h-full backface-hidden rounded-xl">
          <img
            src={back}
            alt=""
            className="w-full h-full min-h-[480px] md:w-72 md:min-h-[420px] lg:min-h-[460px] lg:min-w-80rounded-xl"
          />
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col px-8 py-8 md:py-26 md:px-26 gap-6 lg:mx-18 flex-grow font-opensans font-medium mb-32">
        <div className="flex flex-col text-primary gap-10 text-justify px-2 text-[18px]">
          ...
          <p>
            The core of Solaris is our people. We have worked on projects across the investments
            industry and have met some truly exceptional people, many of whom have chosen to join
            Solaris. We offer them the opportunity to apply themselves to complex, challenging
            change programmes, and to work with like-minded people who enjoy being part of our
            successful team.
          </p>
          <p>
            Solaris is a blend of permanent employees and associates, all of whom share our values
            of client service, integrity and focus on delivering successful outcomes for our
            clients. We choose our people based on their experience – you can expect that Solaris
            consultants will always have demonstrable direct, relevant and recent experience in
            their fields of expertise.
          </p>
          <p className="bg-gray-100 px-4 py-8 rounded-2xl">
            Interested in joining Solaris? We would be happy to hear from you. Contact us{' '}
            <Link to="/#contactUs" className="text-orangeWin">
              here
            </Link>
            .
          </p>
        ...
        <div className="grid gap-x-10 gap-y-16 md:grid-cols-3 justify-items-center sm:pb-6">
          {/* Row 1 */}
          <Card face={StephenFace} back={StephenBack} className="md:col-start-1" />
          <Card face={MathewFace} back={MathewBack} className="md:col-start-2" />
